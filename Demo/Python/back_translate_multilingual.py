...
# Ask for user input
input_sentence = input("Please enter the answer to back-translate: ")

# Ask for language input
source_language = input("Please choose a language from below options you wish to read answer in, and input: \nPunjabi:Pa \nMarathi:Mr \nTamil:Ta \nTelugu:Te \nKannada:Kn\n")
